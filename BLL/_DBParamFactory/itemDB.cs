...
namespace BAL.Repositories
{
    ...
    public class itemDB : baseDB
    {
        ...
        //            SqlParameter[] pp = new SqlParameter[3];
        //            pp[0] = new SqlParameter("@BrandID", data.BrandID);
        //            pp[1] = new SqlParameter("@Title", data.Items);
        //            pp[2] = new SqlParameter("@StatusID", data.Items);
        //            (new DBHelper().ExecuteNonQueryReturn)("sp_UpdateTodaySpecial_Admin", p1);
        //        }
        //        return 1;
        //    }
        //    catch (Exception ex)
